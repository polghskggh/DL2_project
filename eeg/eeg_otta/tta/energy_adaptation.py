...
class EnergyAdaptation(TTAMethod):
    ...
    def sample_q(self, sgld_steps, sgld_lr, sgld_std, reinit_freq, adaptation_steps, batch_size, series_length,
                 n_channels, device, y=None, train_dataset=None, apply_filter=False, align=False, noise_alpha=1, **kwargs):
